    ...
    public static class IServiceCollectionExtensions
    {
            ...
            ServiceAction<ITargetFrameworkNameProvider> addTargetFrameworkNameProviderAction)
        {
            ...
            services
                ...
                .AddSingleton<IBuiltBinariesSourceDirectoryPathProvider, BuiltBinariesSourceDirectoryPathProvider>()
                .AddSingleton<IDateTimedDirectoryPathProvider, DateTimedDirectoryPathProvider>()
                .AddSingleton<IDateTimedDirectoryNameProvider, DateTimedDirectoryNameProvider>()
                .AddSingleton<IDeployBuiltBinariesAction, DeployBuiltBinariesAction>()
                .AddSingleton<IDestinationFileSystemSitesProvider, RivetOrganizationDirectoryDestinationFileSystemSitesProvider>()
                .AddSingleton<IDestinationRootDirectoryPathProvider, RivetOrganizationDirectoryDestinationRootDirectoryPathProvider>()
